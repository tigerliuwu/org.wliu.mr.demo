...
public class Dynamic implements Cloneable, java.io.Serializable {
    ...
    /***
     * @param dbmsId:database mapping id
     * @param column:dynamic column metadata
     * @return column dbType of output table
     */
    public static String getDBTypeFromDynamic(String dbmsId,DynamicMetadata column){
        String dataType = getDefaultSelectedDbType(dbmsId, column.getType());
        String orignalDBType = column.getDbType();
        java.util.List<String> outputDBTypelist = MetadataTalendType.getTalendToDBList(dbmsId, column.getType());
