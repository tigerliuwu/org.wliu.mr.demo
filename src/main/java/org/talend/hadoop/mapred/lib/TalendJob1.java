...
public class TalendJob1 extends JobContext {  
	  ...
	  public TalendJob1() throws IOException {
	    this(new Configuration());
	  }

	  public TalendJob1(Configuration conf) throws IOException {
	    super(conf, null);
	  }

	  public TalendJob1(Configuration conf, String jobName) throws IOException {
	    this(conf);
	    setJobName(jobName);
	  }
