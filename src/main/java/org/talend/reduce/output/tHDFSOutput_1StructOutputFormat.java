...
public class tHDFSOutput_1StructOutputFormat extends FileOutputFormat<NullWritable, row4Struct> {
...
//		Path output2 = FileOutputFormat.getOutputPath(context);
	...
	public RecordWriter<NullWritable, row4Struct> getRecordWriter(
		...
		return new tHDFSOutput_1HDFSRecordWriter(out);
	}
}